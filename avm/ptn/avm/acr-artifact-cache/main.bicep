metadata name = 'avm/ptn/avm/acr-artifact-cache'
metadata description = 'ACR Artifact Cache for AVM Modules'
...
module avmAcrArtifactCache 'br/public:avm/res/container-registry/registry:0.3.1' = {
  name: '${uniqueString(deployment().name, name, location)}-avm-acr-artifact-cache'
  params: {
    name: name
    location: location
    acrSku: acrSku
    ...
    cacheRules: [
      {
        name: 'avmModulesFromMarCacheRule'
...
output name string = avmAcrArtifactCache.outputs.name

@description('The reference to the Azure container registry.')
output loginServer string = avmAcrArtifactCache.outputs.loginServer

@description('The resource ID of the Azure container registry.')
output acrResourceId string = avmAcrArtifactCache.outputs.resourceId

@description('The principal ID of the system assigned identity.')
output systemAssignedMIPrincipalId string = avmAcrArtifactCache.outputs.systemAssignedMIPrincipalId

@description('The location the resource was deployed into.')
output location string = avmAcrArtifactCache.outputs.location
