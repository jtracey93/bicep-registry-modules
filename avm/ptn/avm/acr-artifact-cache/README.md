# avm/ptn/avm/acr-artifact-cache `[Avm/AcrArtifactCache]`

ACR Artifact Cache for AVM Modules
...
>**Note**: To reference the module, please use the following syntax `br/public:avm/ptn/avm/acr-artifact-cache:<version>`.
...
```bicep
module acrArtifactCache 'br/public:avm/ptn/avm/acr-artifact-cache:<version>' = {
  name: 'acrArtifactCacheDeployment'
  params: {
